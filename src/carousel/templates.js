...
function style1a(c, coverUri, logo) {
  return [
    ...
    `<section class="slide pad" style="background:#F7F4EE;">
      <div class="kicker" style="color:#9A9D94; font-size:20px; margin-bottom:28px;">02 · The Challenge</div>
    ...
    // 3 · Solution
    `<section class="slide pad" style="background:#F7F4EE;">
      <div class="kicker" style="color:#9A9D94; font-size:20px; margin-bottom:28px;">03 · The Solution</div>
      <div style="width:80px; height:3px; background:#5A775E; margin-bottom:36px;"></div>
    ...
    // 4 · Results & Impact
    `<section class="slide pad" style="background:#F7F4EE;">
      <div class="kicker" style="color:#9A9D94; font-size:20px; margin-bottom:28px;">04 · Results &amp; Impact</div>
      <div style="width:80px; height:3px; background:#5A775E; margin-bottom:36px;"></div>
...
function style1b(c, coverUri, logo) {
  return [
    ...
    `<section class="slide pad" style="background:#F7F4EE;">
      <div class="kicker" style="color:#5A775E; font-size:20px; margin-bottom:28px;">02 · The Challenge</div>
      <div style="font-family:'Lora',serif; font-size:42px; line-height:1.32; color:#1B1A17; font-weight:500;">${esc(c.challenge)}</div>
      <div style="margin-top:40px; height:2px; background:#EBE3D3;"></div>
      ${footer(logo, '#1B1A17', false)}
    </section>`,
    `<section class="slide pad" style="background:#5A775E;">
      <div class="kicker" style="color:#EBE3D3; font-size:20px; margin-bottom:28px;">03 · The Solution</div>
    ...
    `<section class="slide pad" style="background:#F7F4EE;">
      <div class="kicker" style="color:#5A775E; font-size:20px; margin-bottom:28px;">04 · Results &amp; Impact</div>
...
function style1c(c, coverUri, logo) {
  return [
    ...
    `<section class="slide pad" style="background:#EBE3D3;">
      <div class="kicker" style="color:#4A4942; font-size:20px; margin-bottom:28px;">02 · The Challenge</div>
      <div style="font-family:'Lora',serif; font-size:42px; line-height:1.32; color:#1B1A17; font-weight:500;">${esc(c.challenge)}</div>
      ${footer(logo, '#4A4942', false)}
    </section>`,
    `<section class="slide pad" style="background:#F7F4EE;">
      <div class="kicker" style="color:#5A775E; font-size:20px; margin-bottom:28px;">03 · The Solution</div>
      <div style="font-family:'Lora',serif; font-size:42px; line-height:1.32; color:#1B1A17; font-weight:500;">${esc(c.solution)}</div>
      ${footer(logo, '#1B1A17', false)}
    </section>`,
    `<section class="slide pad" style="background:#EBE3D3;">
      <div class="kicker" style="color:#4A4942; font-size:20px; margin-bottom:28px;">04 · Results &amp; Impact</div>
      <div style="font-family:'Lora',serif; font-size:58px; line-height:1.15; color:#1B1A17; font-weight:600;">${esc(c.resultHeading)}</div>
      <div style="font-family:'Outfit',sans-serif; font-size:24px; color:#4A4942; margin-top:20px;">${esc(c.resultLine)}</div>
      ${footer(logo, '#4A4942', false)}
    </section>`,
...
function style1d(c, coverUri, logo) {
  return [
    ...
    `<section class="slide pad" style="background:#1B1A17;">
      <div class="kicker" style="color:#7AAB7F; font-size:20px; margin-bottom:28px;">02 · The Challenge</div>
    ...
    `<section class="slide pad" style="background:#1B1A17;">
      <div class="kicker" style="color:#7AAB7F; font-size:20px; margin-bottom:28px;">03 · The Solution</div>
      <div style="width:80px; height:3px; background:#7AAB7F; margin-bottom:36px;"></div>
      <div style="font-family:'Lora',serif; font-size:42px; line-height:1.32; color:#F7F4EE; font-weight:500;">${esc(c.solution)}</div>
      ${footer(logo, '#F7F4EE', true)}
    </section>`,
    `<section class="slide pad" style="background:#1B1A17;">
      <div class="kicker" style="color:#7AAB7F; font-size:20px; margin-bottom:28px;">04 · Results &amp; Impact</div>
